...
public class Reflector {
  ...
  //记录了属性相应 的 setter 方法集合 ， key 是属性名称， value 是 Invoker 对象，它是对 setter 方法对应 Method 对象 的封装，后面会详细介绍
  private final Map<String, Invoker> setMethods = new HashMap<String, Invoker>();
  //记录了属性相应 的 getter 方法集合 ， key 是属性名称， value 也是 Invoker 对象
  private final Map<String, Invoker> getMethods = new HashMap<String, Invoker>();
  //记录了属性相应的 setter 方法 的参数值类型， key 是属性名称， value 是 setter 方法的参数类型
  private final Map<String, Class<?>> setTypes = new HashMap<String, Class<?>>();
  //记录了属性相应的 getter 方法的返回值类型， key是属性名称， value 是 getter 方法的返回值类型
  ...
  private void addFields(Class<?> clazz) {
    ...
    for (Field field : fields) {
      ...
      if (field.isAccessible()) {
        ...
        //当 getMethods 集合 中不包含同名属性时，将其记录到 getMethods 集合和 getTypes 集合
